...
class TestSegment:
    ...
    def test_segment_image_returns_tuple(self):
        result = segment_image(self,"tests/img/p09.jpg")
        assert isinstance(result, tuple)
        assert len(result) == 3

    def test_segment_image_output_size(self):
        img=load_image("tests/img/p09.jpg")
        segmented_outfit, mask, mask_array = segment_image(self,"tests/img/p09.jpg")
    ...
    #     segmented_outfit, mask, mask_array = segment_image("tests/img/p09.jpg", additional_option=additional_option)
    ...
    def test_segment_image_consistency(self):
        result1 = segment_image(self,"tests/img/p09.jpg")
        result2 = segment_image(self,"tests/img/p09.jpg")
    ...
    def test_segment_image_different_sizes(self):
        segmented_outfit, mask, mask_array = segment_image(self,"tests/img/p09.jpg", resize=True,size=self.size)#,aspect_ratio=None,square=False)
