    ...
    def __call__(
        ...
        Args:
            ...
            negative_prompt_2 (`str` or `List[str]`, *optional*):
                The negative prompt or prompts to be sent to the `tokenizer_2` and `text_encoder_2`.
            ...
            negative_prompt_embeds (`torch.FloatTensor`, *optional*):
                Pre-generated unconditional text embeddings. Can be used to easily tweak text inputs, *e.g.* prompt weighting.
            pooled_prompt_embeds (`torch.FloatTensor`, *optional*):
                Pre-generated pooled text embeddings.
            negative_pooled_prompt_embeds (`torch.FloatTensor`, *optional*):
                Pre-generated pooled unconditional text embeddings.
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Predict the noise residual for the conditional (text) prompt
                ...
                # Predict the noise residual for the unconditional (negative) prompt
